...
var (
	...
	ErrCategoryOfferAlreadyExist = errors.New("offer already exist for this category")
	ErrProductOfferAlreadyExist  = errors.New("offer already exist for this product")
