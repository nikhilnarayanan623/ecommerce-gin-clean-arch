...
// 		input          request.Login
// 		expectedOutput uint
// 		buildStub      func(mockRepo *mockRepository.MockUserRepository, loginDetails request.Login)
// 		expectedError  error
// 	}{
// 		{
...
// 		buildStubTokenService func(t *testing.T, tokenAuth *mockTokenAuth.MockTokenAuth)
...
// 					Times(1).Return("", errors.New("failed to create token"))
// 			},
// 			buildStubAuthRepo: func(t *testing.T, mockRepo *mockRepository.MockAuthRepository) {
...
// 				assert.Equal(t, errors.New("failed to create token"), actualError)
// 			},
// 		},
// 		{
